      ...
      <v-col cols="12" sm="6">
        <v-card :loading="loading">
          <v-card-text>
            <v-row align="center">
              <v-col cols="8">
                <div class="headline mb-2">Domains</div>
      ...
      <v-col cols="12" sm="6">
        <v-card :loading="loading">
          <v-card-text>
            <v-row align="center">
              <v-col cols="8">
                <div class="headline mb-2">Inactive Domains</div>
      ...
      <v-col cols="12" sm="6">
        <v-card :loading="loading">
          <v-card-text>
            <v-row align="center">
              <v-col cols="8">
                <div class="headline mb-2">International Domains</div>
  ...
  methods: {
    async fetchStats() {
      ...
      try {
        ...
        this.stats = (await this.$axios.get(`http://localhost:3001/stats`)).data;
